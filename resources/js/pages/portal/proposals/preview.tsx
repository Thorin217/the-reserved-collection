            ...
            <div className="flex flex-1 flex-col gap-1">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        {item.product?.brand && (
                            <p className="font-body text-[10px] tracking-[0.2em] text-muted-foreground/50 uppercase">
                                {item.product.brand.name}
                            </p>
                        )}
                    </div>
                    <p className="shrink-0 font-display text-lg font-light text-gold">
            ...
            <div className="min-h-screen bg-background">
                ...
                <div className="border-b border-border bg-background/95 backdrop-blur-md">
                    <div className="mx-auto max-w-2xl px-6 py-8">
                        ...
                        <h1 className="mt-2 font-display text-2xl font-light text-foreground">
                            {proposal.title}
                        </h1>
                        {client && (
                ...
                <div className="mx-auto max-w-2xl px-6 py-8">
                    ...
                    <p className="mt-12 text-center font-body text-[10px] tracking-[0.25em] text-muted-foreground/40 uppercase">
                        This proposal was prepared exclusively for you · The
                        Reserved Collection
                    </p>
                </div>
            </div>
