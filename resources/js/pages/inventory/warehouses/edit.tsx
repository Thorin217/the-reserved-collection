...
export default function WarehousesEdit({ warehouse: { data: warehouse }, branches, warehouseTypes }: Props) {
...
WarehousesEdit.layout = (page: React.ReactNode) => (
    <AppLayout breadcrumbs={[{ title: 'Configuration', href: '#' }, { title: 'Warehouses', href: '/admin/warehouses' }, { title: 'Edit', href: '#' }]}>
        {page}
    </AppLayout>
);
